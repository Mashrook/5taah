...
var host = "5taah-production.up.railway.app" //Set your domain host without http:// or https:// prefixes and without any subdomain like "www."
var webviewurl = "https://5taah-production.up.railway.app" //Set your full web app/website URL including http:// or https:// prefix and including subdomains if they are in your URL, like "www.", for example
...
var safariblacklist = [host, "5taah-production.up.railway.app", "yxojwultjidolgiwyktl.supabase.co", "moyasar.com", "api.moyasar.com",] //Add domains here that should NEVER be opened in Safari, regardless of what the openallexternalurlsinsafaribydefault option is set to; to add another domain, insert another host like so: ["alwaysopeninsafari.com", "google.com", "m.facebook.com"] please enter the host exactly how you link to it (with or without www, but always without http/https)
...
var okbutton = "\u{062D}\u{0633}\u{0646}\u{0627}\u{064B}" //Set the text label of the "OK" buttons of dialogs (if you like, you have the ability to translate this string into two additional languages using the 'alternatelanguage1' and 'alternatelanguage2' strings found at the end of this Config.swift file)

var cancelbutton = "\u{0625}\u{0644}\u{063A}\u{0627}\u{0621}" //Set the text label of the "Cancel" buttons of dialogs (if you like, you have the ability to translate this string into two additional languages using the 'alternatelanguage1' and 'alternatelanguage2' strings found at the end of this Config.swift file)
...
var firstrunmessagetitle = "\u{0645}\u{0631}\u{062D}\u{0628}\u{0627}\u{064B} \u{0628}\u{0643} \u{0641}\u{064A} \u{062E}\u{062A}\u{0647}!" //Set the title label of the "First run" dialog (if you like, you have the ability to translate this string into two additional languages using the 'alternatelanguage1' and 'alternatelanguage2' strings found at the end of this Config.swift file)

var firstrunmessage = "\u{0634}\u{0643}\u{0631}\u{0627}\u{064B} \u{0644}\u{062A}\u{062D}\u{0645}\u{064A}\u{0644} \u{062A}\u{0637}\u{0628}\u{064A}\u{0642} \u{062E}\u{062A}\u{0647}! \u{0627}\u{062D}\u{062C}\u{0632} \u{0631}\u{062D}\u{0644}\u{0627}\u{062A}\u{0643} \u{0628}\u{0633}\u{0647}\u{0648}\u{0644}\u{0629}." //Set the text label of the "First run" dialog (if you like, you have the ability to translate this string into two additional languages using the 'alternatelanguage1' and 'alternatelanguage2' strings found at the end of this Config.swift file)
...
var offlinetitle = "\u{062E}\u{0637}\u{0623} \u{0641}\u{064A} \u{0627}\u{0644}\u{0627}\u{062A}\u{0635}\u{0627}\u{0644}" //Set the title label of the Offline dialog (if you like, you have the ability to translate this string into two additional languages using the 'alternatelanguage1' and 'alternatelanguage2' strings found at the end of this Config.swift file)

var offlinemsg = "\u{064A}\u{0631}\u{062C}\u{0649} \u{0627}\u{0644}\u{062A}\u{062D}\u{0642}\u{0642} \u{0645}\u{0646} \u{0627}\u{062A}\u{0635}\u{0627}\u{0644}\u{0643} \u{0628}\u{0627}\u{0644}\u{0625}\u{0646}\u{062A}\u{0631}\u{0646}\u{062A}." //Set the text of the Offline dialog (if you like, you have the ability to translate this string into two additional languages using the 'alternatelanguage1' and 'alternatelanguage2' strings found at the end of this Config.swift file)

var screen1 = "\u{0627}\u{0646}\u{0642}\u{0637}\u{0639} \u{0627}\u{0644}\u{0627}\u{062A}\u{0635}\u{0627}\u{0644}\u{061F}" //Set the text label 1 of the Offline screen (if you like, you have the ability to translate this string into two additional languages using the 'alternatelanguage1' and 'alternatelanguage2' strings found at the end of this Config.swift file)

var screen2 = "\u{064A}\u{062F}\u{0639}\u{0645} \u{0627}\u{0644}\u{062A}\u{0637}\u{0628}\u{064A}\u{0642} \u{0627}\u{0644}\u{0648}\u{0627}\u{064A}\u{0641}\u{0627}\u{064A} \u{0648}\u{0628}\u{064A}\u{0627}\u{0646}\u{0627}\u{062A} \u{0627}\u{0644}\u{062C}\u{0648}\u{0627}\u{0644}." //Set the text label 2 of the Offline screen (if you like, you have the ability to translate this string into two additional languages using the 'alternatelanguage1' and 'alternatelanguage2' strings found at the end of this Config.swift file)

var offlinebuttontext = "\u{0625}\u{0639}\u{0627}\u{062F}\u{0629} \u{0627}\u{0644}\u{0645}\u{062D}\u{0627}\u{0648}\u{0644}\u{0629}" //Set the text label of the "Try again" button (if you like, you have the ability to translate this string into two additional languages using the 'alternatelanguage1' and 'alternatelanguage2' strings found at the end of this Config.swift file)
...
var imagedownloadedtitle = "\u{062A}\u{0645} \u{062D}\u{0641}\u{0638} \u{0627}\u{0644}\u{0635}\u{0648}\u{0631}\u{0629} \u{0641}\u{064A} \u{0645}\u{0639}\u{0631}\u{0636} \u{0627}\u{0644}\u{0635}\u{0648}\u{0631}." //Set the title label of the "Image saved to your photo gallery" dialog box (if you like, you have the ability to translate this string into two additional languages using the 'alternatelanguage1' and 'alternatelanguage2' strings found at the end of this Config.swift file)

var imagenotfound = "\u{0644}\u{0645} \u{064A}\u{062A}\u{0645} \u{0627}\u{0644}\u{0639}\u{062B}\u{0648}\u{0631} \u{0639}\u{0644}\u{0649} \u{0627}\u{0644}\u{0635}\u{0648}\u{0631}\u{0629}." //Set the title label of the "Image not found" dialog box (if you like, you have the ability to translate this string into two additional languages using the 'alternatelanguage1' and 'alternatelanguage2' strings found at the end of this Config.swift file)

//Custom Status Bar Design

var statusBarBackgroundColor = #colorLiteral(red: 1, green: 0.337, blue: 0.137, alpha: 1) //Define a custom status bar background color

var darkModeStatusBarBackgroundColor = #colorLiteral(red: 0.07, green: 0.07, blue: 0.07, alpha: 1) //Define a custom status bar background color while user is using iOS Dark Mode

var statusBarTextColor = "white" //Define the text color of the status bar ("white" or "black"); requires iOS 13 or higher

var darkModeStatusBarTextColor = "white" //Define the text color of the status bar ("white" or "black")  while user is using iOS Dark Mode; requires iOS 13 or higher; NOTE: choosing "black" deactivates dark mode in the app to prevent an illegible status bar

//Custom Bottom Bar Design

var bottombar = true to prevent the home bar (found in iOS devices with no home button, eg. iPhone X) from overlapping app content; only appears on devices with the homebar
...
var loadingIndicatorColor = #colorLiteral(red: 1, green: 0.337, blue: 0.137, alpha: 1) //Set a color for the loading indicator
...
var zipfilepopuptitle = "\u{062C}\u{0627}\u{0631}\u{064A} \u{062A}\u{062D}\u{062F}\u{064A}\u{062B} \u{0627}\u{0644}\u{0645}\u{062D}\u{062A}\u{0648}\u{0649}" //The title of the popup that will be displayed while downloading the .zip file (if you like, you have the ability to translate this string into two additional languages using the 'alternatelanguage1' and 'alternatelanguage2' strings found at the end of this Config.swift file)

var zipfilepopupmessage = "\u{064A}\u{062A}\u{0645} \u{062A}\u{062D}\u{062F}\u{064A}\u{062B} \u{0645}\u{062D}\u{062A}\u{0648}\u{0649} \u{0627}\u{0644}\u{062A}\u{0637}\u{0628}\u{064A}\u{0642}\u{060C} \u{064A}\u{0631}\u{062C}\u{0649} \u{0627}\u{0644}\u{0627}\u{0646}\u{062A}\u{0638}\u{0627}\u{0631}..." //The message of the popup that will be displayed while downloading the .zip file (if you like, you have the ability to translate this string into two additional languages using the 'alternatelanguage1' and 'alternatelanguage2' strings found at the end of this Config.swift file)
...
static let splashscreencolor = #colorLiteral(red: 1, green: 0.337, blue: 0.137, alpha: 1) //Set a background color for the splash screen
