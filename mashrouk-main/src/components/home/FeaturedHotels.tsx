...
const hotels = [
  {
    ...
    category: "إطلالة بحرية",
    categoryColor: "bg-primary",
    tags: ["واي فاي مجاني", "مسبح", "موقف سيارات"],
    price: "850",
    image: hiltonJeddahImg,
    href: "/hotels",
  },
  {
    name: "فندق الريتز كارلتون",
    location: "الرياض - حي الدبلوماسي",
    category: "فاخر",
    categoryColor: "bg-primary",
    tags: ["سبا", "إفطار شامل", "صالة رياضية"],
    price: "1,200",
    image: ritzCarltonImg,
    href: "/hotels",
  },
  {
    name: "فندق راديسون بلو أبها",
    location: "أبها - وسط المدينة",
    category: "إطلالة جبلية",
    categoryColor: "bg-primary",
    tags: ["إطلالة جبلية", "مسبح", "إفطار"],
    price: "650",
    image: radissonAbhaImg,
    href: "/hotels",
  },
  {
    name: "فندق موفنبيك المدينة",
    location: "المدينة المنورة - المنطقة المركزية",
    category: "قريب من الحرم",
    categoryColor: "bg-primary",
    tags: ["واي فاي مجاني", "إفطار شامل", "خدمة غرف 24/7"],
    price: "950",
    image: movenpickMedinaImg,
    href: "/hotels",
  },
];
