...
const adminGroups: AdminGroup[] = [
  ...
  },
  {
    label: "المحتوى",
    links: [
      { href: "/admin/offers", label: "العروض", icon: Tag, permission: "content.view" },
      ...
      { href: "/admin/activities", label: "النشاطات", icon: CalendarDays, permission: "content.view" },
      { href: "/admin/promo-media", label: "المحتوى الدعائي", icon: Film, permission: "content.view" },
      { href: "/admin/site-content", label: "الصور والأقسام", icon: LayoutDashboard, permission: "content.view" },
      { href: "/admin/study-programs", label: "البرامج الدراسية", icon: FileText, permission: "content.view" },
    ],
  },
  {
  ...
  {
    label: "التكاملات والـ APIs",
    links: [
      { href: "/admin/integrations", label: "الاتصالات والمفاتيح", icon: Key, permission: "endpoints.manage" },
      { href: "/admin/api-keys", label: "مفاتيح APIs", icon: Key, permission: "endpoints.manage" },
      { href: "/admin/amadeus-keys", label: "مفاتيح Amadeus", icon: Key, permission: "endpoints.manage" },
      { href: "/admin/hotel-apis", label: "Hotel APIs", icon: Hotel, permission: "endpoints.manage" },
      { href: "/admin/payment-settings", label: "المدفوعات", icon: CreditCard, permission: "endpoints.manage" },
      { href: "/admin/api-logs", label: "سجلات APIs", icon: ScrollText, permission: "security.audit_logs" },
    ],
  },
  {
    ...
    links: [
      ...
      { href: "/admin/stats", label: "الإحصاءات", icon: BarChart3, permission: "reports.read" },
