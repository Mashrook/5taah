    ...
    <div className="min-h-screen py-12">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-3xl lg:text-4xl font-bold mb-4">من <span className="text-primary">نحن</span></h1>
          <p className="text-muted-foreground max-w-2xl mx-auto">خته هي منصة حجز سفر شاملة تهدف لتوفير أفضل تجربة سفر للعملاء</p>
        </div>
