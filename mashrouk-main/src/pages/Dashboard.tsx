...
import { CalendarDays, Heart, Bell, User, Settings, Plane, Hotel, Car, Map, ArrowRightLeft, ShieldCheck } from "lucide-react";
import { useToast } from "@/hooks/use-toast";

const bookingTypeIcons: Record<string, React.ComponentType<{ className?: string }>> = {
    ...
    <div className="min-h-screen py-12">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="mb-10">
          ...
          {isAdmin && (
            <Link to="/admin" className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-primary/10 border border-primary/20 text-primary hover:bg-primary/20 transition-colors text-sm font-semibold">
