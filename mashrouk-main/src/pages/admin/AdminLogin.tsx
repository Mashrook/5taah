...
export default function AdminLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const shouldRetryWithoutEdgeSpaces = rawPassword !== trimmedPassword;
      ...
      if (authError?.message === "Invalid login credentials" && shouldRetryWithoutEdgeSpaces) {
      ...
      toast({
        ...
        description: errorMessage === "Invalid login credentials" ? "بيانات الدخول غير صحيحة" : errorMessage,
        variant: "destructive",
      });
    } finally {
      setLoading(false);
