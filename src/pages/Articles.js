...
var fallbackArticles = [
  ...
  { _id: 'a2', title: '✈️ نصائح ذهبية لحجز أرخص تذاكر الطيران', category: 'tips', date: '٢٠٢٥/٠١/١٠', excerpt: 'تعلم أسرار الحصول على أفضل أسعار الطيران. مواعيد الحجز المثالية وشركات الطيران الاقتصادية من السعودية.', readTime: '٤ دقائق', author: 'فريق خته' },
  ...
  { _id: 'a7', title: '🏖️ أفضل الشواطئ في الخليج العربي', category: 'destinations', date: '٢٠٢٤/١٢/١٠', excerpt: 'من شواطئ دبي إلى جزر البحرين وسواحل عمان. دليلك لأجمل الشواطئ القريبة مع نصائح للعائلات.', readTime: '٥ دقائق', author: 'فريق خته' },
...
function renderArticles(articles) {
  ...
  try {
    ...
    rep.onItemReady(function ($i, d) {
      ...
      try { $i('#articleAuthor').text = '✍️ ' + d.author; } catch (e) {}
      try {
