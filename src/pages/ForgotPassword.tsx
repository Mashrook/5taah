    ...
    <div className="min-h-screen flex items-center justify-center py-12 bg-background">
      <div className="w-full max-w-md mx-4">
        <div className="text-center mb-8">
          ...
          <p className="text-primary/80 text-sm mt-2">أدخل بريدك الإلكتروني لإرسال رابط إعادة التعيين</p>
        </div>

        {sent ? (
          <div className="p-6 rounded-2xl bg-card/80 backdrop-blur border border-primary/20 shadow-lg text-center space-y-4">
            <p className="text-foreground font-medium">تم إرسال رابط إعادة التعيين إلى بريدك الإلكتروني</p>
            <p className="text-muted-foreground text-sm">يرجى التحقق من صندوق الوارد والبريد العشوائي</p>
            <Link to="/login">
