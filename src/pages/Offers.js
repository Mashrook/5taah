...
var fallbackOffers = [
 { _id: 'o1', title: 'عرض دبي الشامل', desc: 'طيران + فندق ٤ نجوم + جولة سياحية - ٣ ليالي', price: '٢,٤٩٩ ر.س', oldPrice: '٣,٢٠٠ ر.س', segment: 'luxury', badge: 'خصم ٢٢٪', expires: 'ينتهي خلال ٥ أيام'},
 ...
 { _id: 'o4', title: 'مغامرة جورجيا', desc: 'طيران + فندق + رحلات جبلية وتجارب محلية - ٤ ليالي', price: '٣,٢٩٩ ر.س', oldPrice: '٤,٢٠٠ ر.س', segment: 'adventure', badge: 'جديد', expires: 'متوفر حتى الصيف'},
 { _id: 'o5', title: 'منتجع المالديف', desc: 'إقامة فاخرة في فيلا مائية مع جميع الوجبات - ٤ ليالي', price: '٨,٩٩٩ ر.س', oldPrice: '١٢,٠٠٠ ر.س', segment: 'luxury', badge: 'خصم ٢٥٪', expires: 'الأماكن محدودة'},
