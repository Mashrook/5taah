...
var highlights = [
 {
 _id: 'h1', name: 'العلا', region: 'المدينة المنورة',
 ...
 {
 _id: 'h5', name: 'الرياض', region: 'الرياض',
...
$w.onReady(async function () {
 ...
 /* ——— Saudi Offers ——————————————————— */
 var saudiOffers = [
 { _id: 'so1', title: 'باقة العلا الشاملة', desc: '٣ ليالي + جولات + طيران', price: '٢,٤٩٩ ر.س', badge: 'الأكثر حجزاً'},
