...
var tours = [
  { _id: 't1', name: '🏜️ جولة العلا التراثية', category: 'culture', duration: 'يومان', price: '١,٢٩٩ ر.س', desc: 'استكشف مدائن صالح والمواقع الأثرية مع مرشد متخصص', rating: '٤.٨ ⭐', groupSize: '٤-١٢ شخص' },
  ...
  { _id: 't4', name: '🍽️ جولة طعام جدة التاريخية', category: 'food', duration: '٤ ساعات', price: '١٩٩ ر.س', desc: 'تذوق أشهى الأطباق الحجازية في أزقة البلد القديمة', rating: '٤.٩ ⭐', groupSize: '٢-١٠ أشخاص' },
  { _id: 't5', name: '🏔️ تسلق جبال الحجاز', category: 'nature', duration: 'يوم واحد', price: '٣٤٩ ر.س', desc: 'تسلق جبل اللوز والاستمتاع بإطلالات خلابة', rating: '٤.٦ ⭐', groupSize: '٤-١٠ أشخاص' },
...
$w.onReady(async function () {
  ...
  setText('#pageTitle', '🗺️ جولات وتجارب');
